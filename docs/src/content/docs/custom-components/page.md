---
title: Page
description: Page custom component
sidebar:
  order: 3
---
...
To learn about installing the Kissflow SDK inside custom components, follow [these](/custom-components/project-scaffolding/) instructions.
